/* ============================================================================
 * DOLPHLINK QR Scanner — self-contained module loaded on-demand from
 * engine/home/register.js.
 *
 * Scope: HOMEPAGE ONLY.
 *
 * Public API:
 ...
 *
 * Self-hosted only — vendor lib/jsQR.js. No CDN fallback by policy.
 *
...
`;
  ...
  function loadJSQR() {
    ...
    return new Promise(function (resolve, reject) {
      ...
      s.onerror = function () {
        reject(new Error('jsQR load failed (vendor lib/jsQR.js missing)'));
      };
      document.head.appendChild(s);
    });
  }
