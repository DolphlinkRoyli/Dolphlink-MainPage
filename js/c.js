/* ============================================================================
 * DOLPHLINK Digital Card — Landing Page Logic
 *
 * Loaded from /c/index.html as ../js/c.js
 *
 * URL format:
 ...
 *
 * Pre-read loader (#dlpk-loader, identical to main site) covers the page
 * until data is fetched + rendered, then fades out.
 *
...
(function () {
 ...
 // ----------------------------------------------------------------------------
 // Pre-read loader removal — shared logic with main site
 // ----------------------------------------------------------------------------
 function hideLoader() {
 ...
 // Safety timeout — never strand a user on the spinner
